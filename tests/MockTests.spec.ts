...
test.describe('API Tests Mock and real', () => {
    test('Mock a real API providing a value that is not contained in the response', async ({ }) => {
    ...
    test('Get real response and add a value to the response', async ({ }) => {
